        ...
        <div className="hidden lg:flex lg:w-1/2 bg-primary-600 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
            <div className="max-w-md">
              <div className="mb-8">
                <h1 className="text-5xl font-bold mb-4">ManaHR</h1>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">Attendance Management</h3>
                    <p className="text-sm text-white/70">Track employee attendance with clock in/out</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/70">Apply and approve leaves seamlessly</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">Payroll Processing</h3>
                    <p className="text-sm text-white/70">Automated payroll with detailed payslips</p>
                  </div>
                </div>
              </div>
            </div>
